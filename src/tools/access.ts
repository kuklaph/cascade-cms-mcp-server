 ...
 *
 *   read_access_rights — fetch ACL for an asset
 *   edit_access_rights — modify ACL (optionally cascade to children)
 *
...
Examples:
  ...
  - Don't use when: You want to change permissions — use edit_access_rights.
  - Don't use when: You want workflow settings — use read_workflow_settings.
...
Examples:
  ...
  - Don't use when: You only want to read — use read_access_rights.
  - Don't use when: You want to change workflow policy — use edit_workflow_settings.
